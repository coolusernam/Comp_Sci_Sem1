...
public class Ascii {
	...
	public String checkType(String a){					// Checks if the input String a is valid
		...
		else if(a.equals("cat") || a.equals("Cat")){
			return "Cat";
		}
		else{
			return "Human";
	...
	public void printArt(){				// Prints out the name and the art number times
		...
		while (i < number){
			if(type.equals("Human")){
				...
				//System.out.println("Oo.oOo.Oo.oOo.Oo.oOo.");  // Ascii art for other 
			}
			else if(type.equals("Cat")){
				System.out.println("0-0 this is a cat");
			}
			else{
